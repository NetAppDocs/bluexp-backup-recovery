...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-6.png[Six] Prepare Google Cloud as your backup target

[role="quick-margin-para"]
Set up permissions for the Connector to create and manage the Google Cloud bucket. 

[role="quick-margin-para"]
Optionally, you can set up your own custom-managed keys for data encryption instead of using the default Google Cloud encryption keys. <<Prepare Google Cloud Storage as your backup target,Learn how to get your Google Cloud environment ready to receive ONTAP backups.>>
