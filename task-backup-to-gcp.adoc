...
You can use your own customer-managed keys for data encryption instead of using the default Google-managed encryption keys. If you're planning to use your own customer-managed keys: 
+
...
+
* You'll need to enable the Google "Cloud Key Management Service (KMS)" API in your project. See the https://cloud.google.com/apis/docs/getting-started#enabling_apis[Google Cloud documentation: Enabling APIs] for details.
+
* *CMEK considerations:*
+
