...
| On-premises ONTAP system | On-premises ONTAP system  |On-premises ONTAP system
|
ifdef::aws[]
Amazon S3
endif::aws[]
...
BlueXP backup and recovery installs the NetApp SnapCenter Plug-in for Microsoft SQL Server on the server that hosts MS SQL Server.

The SnapCenter Plug-in for Microsoft SQL Server is a host-side component of the NetApp SnapCenter Software that enables application-aware data protection management of Microsoft SQL Server databases. 
