...
NOTE: Documentation about protecting VMware and Kubernetes workloads is provided as a technology preview. With this preview offering, NetApp reserves the right to modify offering details, contents, and timeline before General Availability.   
...
** Protect your VMware VMs and datastores with BlueXP backup and recovery. 
