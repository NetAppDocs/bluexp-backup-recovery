...
[.lead]
The BlueXP backup and recovery service provides efficient, secure, and cost-effective data protection for ONTAP volumes, Microsoft SQL Server instances and databases, VMware workloads, and Kubernetes workloads. 
...
* Back up ONTAP volumes, Microsoft SQL Server instances and databases, VMware workloads and Kubernetes workloads
...
* ONTAP volumes 
* VMware datastores
* Microsoft SQL Server instances and databases for VMware Virtual Machine File System (VMFS) and VMware Virtual Machine Disk (VMDK) NFS
