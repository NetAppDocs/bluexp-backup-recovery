...
** Refer to link:prev-ontap-protect-overview.html[Protect ONTAP volumes] for details about protecting ONTAP volumes.

* *Microsoft SQL Server workloads (Preview without SnapCenter)*: 
...
** Refer to link:br-use-mssql-protect-overview.html[Protect Microsoft SQL Server workloads] for details about protecting Microsoft SQL Server workloads.

* *Virtual machine (VM) workloads (Preview without SnapCenter Plug-in for VMware vSphere)*: 
...
** Refer to link:br-use-vmware-protect-overview.html[Protect VMware workloads] for details about protecting VMware workloads.
...
** Use BlueXP backup and recovery along with SnapCenter. 
** Refer to link:prev-vmware-protect-overview.html[Protect VMware workloads] for details about protecting VMware workloads.
...
** Use BlueXP backup and recovery without SnapCenter.
** Refer to link:br-use-kubernetes-protect-overview.html[Protect Kubernetes workloads] for details about protecting Kubernetes workloads.
...
* VMware VMs, datastores, and applications on VMs (Preview without SnapCenter Plug-in for VMware vSphere))
* VMware VMs, datastores, and applications on VMs (using SnapCenter Plug-in for VMware vSphere)
