...
+
* After you select a volume, then you can select all volumes of that same style of FlexVol or FlexGroup. To back up all existing volumes and any volumes added in the future, check one volume first and then check the box in the title row. (image:button_backup_all_volumes.png[]).
+
