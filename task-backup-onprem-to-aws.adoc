...
* Select volumes
* Define backup strategy, where you choose whether you want local Snapshots, replication, and backup. Then, you choose the architecture, local Snapshot policy, replication target and policy, backup information (provider, encryption, networking, backup policy, and export options). 
...
. Access the Activate backup and recovery wizard by doing one of the following: 

* From the BlueXP backup and recovery left navigation, select *Activate backup and recovery*. 
...
Choose the volumes you want to protect. 

You can choose to protect FlexVol or FlexGroup volumes; however, you cannot select a mix of these for this working environment.  
