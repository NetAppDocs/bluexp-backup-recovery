...
* From the BlueXP canvas, select the working environment and click *Enable > Backup Volumes* next to the Backup and recovery service in the right-panel.
+
...
* Select *Volumes* in the top bar. From the Volumes tab, select the *Actions ...* option and select *Activate 3-2-1 Protection*. 
