...
====
*NOTE*   To switch to and from BlueXP backup and recovery UI versions, refer to link:prev-start-switch-ui.html[Switch to the previous BlueXP backup and recovery UI].
====
