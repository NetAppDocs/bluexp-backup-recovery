...
NOTE: These settings are available for backup to object storage only. None of these settings affect your Snapshot or replication settings. Similar features will be added for cluster-level replications settings in the future.
