...
IMPORTANT: Cloud Backup for Applications infrastructure supports failing over to a new region only. The failover involves a downtime of around 2 hours. The infrastructure does not support availability zone failures within a region.
