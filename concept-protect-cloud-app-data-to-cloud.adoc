...
* Cloud Backup for Applications is a set of data protection services hosted as a SaaS service by NetApp and is based off the Cloud Manager SaaS platform.
+
...
+
The Cloud Backup for Applications UI is served from the Cloud Manager SAAS framework managed by NetApp that offers multiple storage and data management capabilities.
* Cloud Manager Connector is a component from Cloud Manager that runs in your cloud network and interacts with the SnapCenter Plug-in for Oracle running on Oracle database hosts and Amazon FSx storage file systems.
...
** Full (data + control + archive log files) backup of Oracle databases
** On-demand backup of Oracle databases
** Scheduled backup of Oracle databases based on the system-defined or custom policies
+
