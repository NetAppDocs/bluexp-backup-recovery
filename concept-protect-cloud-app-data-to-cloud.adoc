...
** Clone entities name could be auto-generated or be identical to the source
...
* For Multi-node configuration support, only one worker node along with the master node are supported
