...
* You have discovered the Kubernetes cluster as a BlueXP working environment. https://docs.netapp.com/us-en/bluexp-kubernetes/task/task-kubernetes-discover-gke.html[See how to discover the Kubernetes cluster^].
