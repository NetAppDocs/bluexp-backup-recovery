...
[role="quick-margin-para"]
Optionally, you can set up your own custom-managed keys for data encryption instead of using the default Google Cloud encryption keys. <<Prepare Google Cloud as your backup target,Learn how to get your Google Cloud environment ready to receive ONTAP backups.>>
