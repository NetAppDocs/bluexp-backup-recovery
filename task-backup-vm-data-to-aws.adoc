...
[.lead]
You can back up one or more datastores simultaneously to Amazon Web Services by integrating the SnapCenter Plug-in for VMware vSphere with Cloud Manager. This will help the VM administrators to easily and quickly back up and archive data for storage efficiency and accelerate cloud transition.
