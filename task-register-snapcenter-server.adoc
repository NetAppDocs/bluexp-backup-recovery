...
NOTE: For SQL Server databases, the Application Name column displays the name in _application_name (instance name)_ format. When you search by providing the name in _application_name (host name)_ format, the SQL Server database details are not displayed.
