...
* *SnapMirror and snapshot format*: Optionally, enter your own snapshot name in a policy that governs the backups for Microsoft SQL Server workloads. Enter the format, custom text, and the SnapMirror volume prefix and suffix that you want to use.
+
