...
Organization admin, SnapCenter admin, or Folder or project admin. https://docs.netapp.com/us-en/bluexp-setup-admin/reference-iam-predefined-roles.html[Learn about BlueXP access roles for all services^].
...
* Optionally, select *Advanced* to set the SnapMirror label and enable snapshot locking (not available for Kubernetes workloads). 
