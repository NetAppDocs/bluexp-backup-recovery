...
NOTE: You can't delete individual volume backup files once the relationship has been deleted. You can, however, link:task-manage-backups-ontap.html#delete-all-backup-files-for-a-volume[delete all backups for the volume] if you want to remove all backup files.
