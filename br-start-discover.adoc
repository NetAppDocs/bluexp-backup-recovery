...
[.lead]
The BlueXP backup and recovery service needs to first discover data in order for you to use the service. During discovery, BlueXP backup and recovery analyzes Microsoft SQL Server instances and databases in working environments within your organization. 
...
== Discover Microsoft SQL Server workloads
...
. From the BlueXP backup and recovery "Welcome to the new BlueXP backup and recovery" landing page, select *Discover and manage*. 

. *NOTE TO REVIEWERS: HOW DO YOU GET TO THE IMPORT SNAPCENTER OPTION FROM the landing page > Discover and manage?* 


. From the BlueXP backup and recovery Inventory page, select *Import from SnapCenter*.
