...
+
* If you are logging in to this service from a previous version of BlueXP backup and recovery, the "Welcome to the new BlueXP backup and recovery" page appears. Select *Start*. 
+
