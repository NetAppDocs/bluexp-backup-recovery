...
DataLock and Ransomware Scan are separate features. To avoid extra charges, you can disable scheduled ransomware scans while keeping the DataLock feature active. This lets you customize your security settings and avoid incurring costs from the cloud provider. 
