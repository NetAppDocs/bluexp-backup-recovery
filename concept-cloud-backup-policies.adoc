...
The level of protection needed is based on your risk tolerance. If your risk tolerance is low, then you should obtain the highest level of protection. If your risk tolerance is high, then you might not need DataLock enabled. 

You can choose higher levels of protection with increased costs: 

* *DataLock without ransomware scans*: Provides protection for backup data in the destination storage which can be either in Governance or Compliance mode. 
...
* *DataLock with ransomware scans*: Provides an additional layer of security for your data. This feature helps detect any attempts to change backup copies. If any attempt is made, a new version of the data is created discreetly. While the default scan is 7 days, it can be reduced to 1, 2, 3, 4, 5, or 6 days. If reduced to 1 day, the costs increase significantly. 

For details on tips to mitigate DataLock costs, refer to
