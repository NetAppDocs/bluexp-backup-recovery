...
See link:br-start-setup.html[Set up backup destinations before you use BlueXP backup and recovery] for details about how to set up the backup destinations.
