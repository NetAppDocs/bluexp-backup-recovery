...
* Kubernetes distributions / versions that we support
...
* You need to have installed a BlueXP working environment (already documented in BXP docs, link to it)
* You need to have hardware or VMs available for a new Kubernetes cluster (or you need an existing cluster)

=== Requirements for 3-2-1 protection scheme
