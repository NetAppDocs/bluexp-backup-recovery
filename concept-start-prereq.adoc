...
== Requirements for Microsoft SQL Server host 
...
=== Requirements for VMware workloads

To use BlueXP backup and recovery for VMware workloads, you need the following host system, space, and sizing prerequisites.
