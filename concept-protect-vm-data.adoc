...
You can back up datastores to Amazon Web Services S3, Microsoft Azure Blob (supported archival tier is Azure Archive), Google Cloud Platform, and StorageGRID.
