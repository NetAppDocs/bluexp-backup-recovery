...
You can link:task-manage-vm-data-in-cloud.html#create-policy[create a policy] or use one of the following default policies that are available in Cloud Manager.
