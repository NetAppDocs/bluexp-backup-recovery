...
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-azure.html[Deploy a Connector in Azure^]
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-install-restricted-mode.html[Installing the Connector manually on a Linux host in an Azure region^]
