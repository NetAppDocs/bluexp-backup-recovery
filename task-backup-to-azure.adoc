...
* After you select the first volume, then you can select all FlexVol volumes. To back up all existing FlexVol volumes, check one volume first and then check the box in the title row. (image:button_backup_all_volumes.png[]).
