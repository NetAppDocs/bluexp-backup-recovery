...
* You have a Connector installed in Azure. The Connector can be installed in a site with or without internet access.
...
The Connector can be installed in an Azure region with or without internet access. When deployed in a site with no internet access, Azure IL6 secure regions and Azure Commercial regions are supported.

* https://docs.netapp.com/us-en/cloud-manager-setup-admin/concept-connectors.html[Learn about Connectors^]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-creating-connectors-azure.html[Deploy a Connector in Azure^]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-install-connector-onprem-no-internet.html[Installing the Connector on a Linux host in an Azure region without internet access^]
...
Cloud Backup is supported in all Azure regions https://cloud.netapp.com/cloud-volumes-global-regions[where Cloud Volumes ONTAP is supported^]; including Azure Government regions and https://learn.microsoft.com/en-us/azure/compliance/offerings/offering-dod-il6[Azure IL6^] secure regions.
