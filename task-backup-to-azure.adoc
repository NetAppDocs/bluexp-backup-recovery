...
The Connector can be installed in an Azure region with or without internet access. When deployed in a site with no internet access, Azure IL6 and Azure Commercial sites are supported.
