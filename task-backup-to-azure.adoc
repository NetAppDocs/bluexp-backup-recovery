...
+
TIP: If you want to create a custom Snapshot policy, you can use BlueXP backup and recovery, System Manager or the ONTAP CLI `snapmirror policy create` command.
link:task-policies-ontap.html[Create a policy using BlueXP backup and recovery] 
https://docs.netapp.com/us-en/ontap-cli-9131/snapmirror-policy-create.html[Use the `snapmirror policy`^ in ONTAP CLI].
...
+
TIP: If you want to create a custom Replication policy, you can use BlueXP backup and recovery, System Manager or the ONTAP CLI `snapmirror policy create` command.
link:task-policies-ontap.html[Create a policy using BlueXP backup and recovery] 
https://docs.netapp.com/us-en/ontap-cli-9131/snapmirror-policy-create.html[Use the `snapmirror policy`^ in ONTAP CLI].
...
+
TIP: If you want to create a custom Backup to object storage policy, link:task-policies-ontap.html[create a policy using BlueXP backup and recovery] 
