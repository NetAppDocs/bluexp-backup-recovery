...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png[Four] Prepare source and destination systems for replication
...
NOT DONE YET FOR CVO AND AZURE. NEED Figma info. 
