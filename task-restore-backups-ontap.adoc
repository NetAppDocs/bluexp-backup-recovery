...
TIP: For this support, the Connector can be deployed in your cloud provider or on your premises when sending backups to Amazon S3 or Azure Blob. The Connector must be deployed in the cloud when sending backups to Google Cloud Storage.
