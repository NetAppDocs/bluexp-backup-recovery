...
[.lead]
You can only restore the Oracle database to the same host where the backup was created. For a RAC database, the data will be restored to the on-premises node where the backup was created.
