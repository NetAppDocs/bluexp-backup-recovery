...
summary: Create and manage protection groups for VMware workloads in BlueXP backup and recovery. 
---
...
[.lead]
Create protection groups to manage the backup and restore operations for a set of workloads.  A protection group is a logical grouping of workloads that you want to protect together.
