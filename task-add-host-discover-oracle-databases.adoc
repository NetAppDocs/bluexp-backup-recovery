...
** Install the plug-in using script and add host from the UI using manual option. <<Add host from UI using manual option and install the plug-in using script, Learn more>>.
* If SSH is disabled, install the plug-in manually and add host from the UI using manual option. <<Add host from UI using manual option and install the plug-in manually, Learn more>>.
