...
* You have purchased link:task-licensing-cloud-backup.html#use-a-cloud-backup-byol-license[and activated^] a BlueXP backup and recovery BYOL license from NetApp.
...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-on-prem.html[Installing the Connector on a Linux host with internet access^]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-private-mode.html[Installing the Connector on a Linux host without internet access^]
...
== Enabling BlueXP backup and recovery to StorageGRID
