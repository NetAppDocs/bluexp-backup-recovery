...
Tiering older backup files to archival storage saves money by using a less expensive storage class for backups that you may not need. StorageGRID is an on-premises solution that doesn't offer archival storage, but you can move older backup files to public cloud archival storage. 
