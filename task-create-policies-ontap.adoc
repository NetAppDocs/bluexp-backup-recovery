...
* *Ransomware protection*: Shows if the policy includes snapshot lockin on the local snapshot, snapshot locking on secondary storage, or DataLock locking on object storage. 
