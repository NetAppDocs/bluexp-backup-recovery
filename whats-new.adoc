...
This is the first general availability (GA) release of BlueXP backup and recovery for Microsoft SQL Server workloads using a newly designed user interface. It includes the following updates.
