...
* SAP HANA databases
** Supports connect and copy restore of Non-Data Volumes and Global Non-Data  volumes having ANF secondary protection
...
** Supports Oracle Recovery Manager (RMAN) cataloging
