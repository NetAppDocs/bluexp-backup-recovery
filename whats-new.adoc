...
=== BlueXP backup and recovery now includes the ability to create replicated volumes

BlueXP backup and recovery now enables you to implement a 3-2-1 strategy where you have 3 copies of your source data on 2 different storage systems along with 1 copy in the cloud. After activation, you'll have a:
...
=== Ability to create your buckets for backup to object storage
