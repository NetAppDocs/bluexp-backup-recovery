...
https://review.docs.netapp.com/us-en/bluexp-backup-recovery_br-se-ja/task-restore-backups-ontap.html[Learn more about restoring ONTAP data from backup files].
