...
If your cluster is using ONTAP 9.11.1 or greater, and your backup destination is Amazon S3, a new section called _DataLock and Ransomware protection_ is available when you create a backup policy.
...
This functionality already existed for Amazon S3 buckets.
