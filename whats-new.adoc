...
[IMPORTANT]
====
Because of an important security enhancement, your Connector now requires outbound internet access to two additional endpoints in order to manage backup and recovery resources within your public cloud environment. If these endpoints have not been whitelisted in your firewall you'll see an error in the UI about "Service Unavailable" or "Failed to determine service status":
