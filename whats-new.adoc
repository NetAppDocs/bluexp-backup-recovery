...
---
= What's new with BlueXP backup and recovery Preview 2025
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
== 31 January 2025 
//Add here for now then move to include file. 
...
* The Preview version enables you to back up and restore Microsoft SQL Server databases. 
