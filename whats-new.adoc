...
Backup files are initially created in the Google Standard storage class. Now you can choose in the Cloud Backup UI to tier older backups to Google Archive storage after a certain number of days for further cost optimization. 
