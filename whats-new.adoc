...
* Supports Google Cloud Provider (GCP) and StorageGRID
...
=== Enahnacments to Cloud Backup for Virtual Machines

* Create custom policies to back up datastores to cloud.
* Back up one or more datastores to StorageGRID by integrating the SnapCenter Plug-in for VMware vSphere with Cloud Manager.
=======
== 19 September 2022
...
>>>>>>> 36ba1562cdc0ee8e44d03e9dd2b2ce4daf26c244
