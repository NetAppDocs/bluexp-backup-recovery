...
=== Object tagging available on volumes for sorting

You can now add custom tags to volumes so that you can group volumes together within and across working environments. Doing this enables you to sort volumes in the UI pages and filter in reports. 
