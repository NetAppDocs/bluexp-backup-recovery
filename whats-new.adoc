...
https://docs.netapp.com/us-en/bluexp-backup-recovery/task-create-policies-ontap.html[Learn more].
...
https://docs.netapp.com/us-en/bluexp-backup-recovery/task-restore-backups-ontap.html[Learn more].

=== Support for SnapLock Compliance for FlexGroup and FlexVol volumes

While SnapLock Enterprise was already supported with FlexVol volumes, support for SnapLock Compliance is introduced in ONTAP 9.14 and is now supported in BlueXP backup and recovery. 

With this release, you can back up FlexGroup volumes and FlexVol volumes to low-cost public cloud object storage or StorageGRID. 

https://docs.netapp.com/us-en/bluexp-backup-recovery/concept-ontap-backup-to-cloud.html[Learn more].
