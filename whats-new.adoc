...
* You can now create custom policies to back up datastores to cloud.
* You can back up one or more datastores to StorageGRID by integrating the SnapCenter Plug-in for VMware vSphere with Cloud Manager.
