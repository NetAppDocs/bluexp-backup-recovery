...
To back up workloads, typically you create policies that govern the backup and restore operations. See link:task-create-policies-ontap.html[Create policies] for more information.
