...
== Prepare source and destination systems for replication USING INCLUDE
//This section uses an Include for all providers. 

include::../_include/backup-onprem-prepare-source-destination-systems-for-repl.adoc[]

== Prepare source and destination systems for replication REMOVE WHEN INCLUDE WORKS
