...
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-azure.html[Installing a Connector in Azure^]
...
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-install-restricted-mode.html[Installing a Connector in an Azure Government region^]
+
