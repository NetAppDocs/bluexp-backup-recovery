...
Note that Cloud Backup is supported in Government Cloud regions only when the Connector is deployed in the cloud - not when it is installed in your premises or in a dark site.
