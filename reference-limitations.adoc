...
* BlueXP backup and recovery does not back up volumes to object storage that have NetApp Volume Encryption (NVE) enabled and NetApp Aggregate Encryption (NAE) enabled in ONTAP.
+ 
