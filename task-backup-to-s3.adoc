...
The Connector can be installed in an AWS region with or without internet access. When deployed in a site with no internet access, AWS C2S/SC2S and AWS Commercial sites are supported.
