...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-aws.html[Deploy a Connector in AWS^]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-install-restricted-mode.html[Installing the Connector manually on a Linux host in an AWS region^]
