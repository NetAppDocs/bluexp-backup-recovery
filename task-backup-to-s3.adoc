...
The Connector can be installed in an AWS region with full or limited internet access ("standard" or "restricted" mode). https://docs.netapp.com/us-en/bluexp-setup-admin/concept-modes.html[See BlueXP deployment modes for details^].
