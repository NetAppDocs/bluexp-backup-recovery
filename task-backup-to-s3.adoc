...
[NOTE] 
====
If you are creating backups in AWS GovCloud or AWS China regions, you'll need to change the AWS Resource Name "arn" under all _Resource_ sections in the sets of permissions above and below:
