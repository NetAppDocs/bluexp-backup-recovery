...
The Connector can be installed in an AWS region with or without internet access. At this time, only AWS Commercial sites are supported for sites without internet access.
