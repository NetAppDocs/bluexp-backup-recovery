...
You should manually deploy the SnapCenter Plug-in for Oracle on each of the Oracle database hosts. Depending on whether you have SSH key and scp on the Oracle host, you can follow one of the methods to deploy the plug-in.
