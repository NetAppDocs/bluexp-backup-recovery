...
You can restore a resource from any type of backup file (snapshot, replication, or object storage), but you can restore a folder or individual files only from a backup file in object storage.
