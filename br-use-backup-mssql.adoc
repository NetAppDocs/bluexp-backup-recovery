...
TIP: To back up workloads on a schedule, you create policies that govern the backup and restore operations. See link:task-create-policies-ontap.html[Create policies] for more information.
