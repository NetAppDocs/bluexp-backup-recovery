...
+ 
link:prev-ontap-object-options.html[Learn more about archival storage settings].
...
+
link:prev-ontap-object-options.html[Learn more about the available DataLock settings].
