...
NOTE: Job details appear only for ONTAP volume backup and restore jobs. Scheduled backup job details appear only for Cloud Volumes ONTAP systems beginning with ONTAP 9.13.0. Job details appear for in-progress and completed jobs. 
