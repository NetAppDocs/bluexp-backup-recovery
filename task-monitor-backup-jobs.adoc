...
| Local Snapshot | *To TEAM: I understand this is NOT IN AUG 7* BlueXP backup and recovery scheduled Snapshot creation job failure | Error | Yes
| Replication | *To TEAM: I understand this is NOT IN Aug 7* BlueXP backup and recovery scheduled replication job failure | Error | Yes
