...
* You can choose to tier backups to AWS S3 Glacier or S3 Glacier Deep Archive storage. link:prev-reference-aws-backup-tiers.html[Learn more about AWS archival tiers].  
