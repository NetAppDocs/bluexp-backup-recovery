...
Before you update the connector, you should check the link:task-add-host-discover-oracle-databases.html#prerequisites[prerequisites.]
...
Before you update the connector, you should check the link:task-deploy-snapcenter-plugin-for-sap-hana.html#prerequisites[prerequisites.]
