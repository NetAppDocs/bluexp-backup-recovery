...
+
TIP: To create a custom policy using this service before activating the Snapshot, refer to link:task-create-policies-ontap.html[Create a policy].
+
...
+
TIP: To create a custom policy before activating the backup using the UI, refer to link:task-create-policies-ontap.html[Create a policy].
+
To create a policy, select *Create new policy* and do the following: 
+
** Enter the name of the policy. 
