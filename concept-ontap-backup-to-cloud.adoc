...
See link:concept-cloud-backup-policies.html#archival-storage-for-older-backup-files[Archival storage settings] for more details about archiving older backup files.
