...
If your cluster is using ONTAP 9.11.1 or greater, and your backup destination is Amazon S3, you can protect your backups from deletion and ransomware attacks. apply DataLock and Ransomware protection settings
