...
* link:concept-cloud-backup-policies.html#datalock-and-ransomware-protection[How DataLock and Ransomware protection work].

* link:manage-backup-settings-ontap.html[How to update Ransomware protection options in the Advanced Settings page].
