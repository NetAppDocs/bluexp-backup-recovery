...
* Ability to perform a "quick restore" of a volume from cloud storage to a Cloud Volumes ONTAP system; perfect for disaster recovery situations where you need to provide access to a volume as soon as possible.
